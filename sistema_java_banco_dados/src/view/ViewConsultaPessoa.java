 ...
 */
public class ViewConsultaPessoa extends javax.swing.JDialog {
     ...
     */
    public ViewConsultaPessoa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewConsultaPessoa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewConsultaPessoa dialog = new ViewConsultaPessoa(new javax.swing.JFrame(), true);
